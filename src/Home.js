            ...
            <div className="row">
                ...
                <div className="col2">
                    ...
                    <h2>Exploration Game</h2>
                        <p>Discover different pangolin habitats in the <Link to='/game'> exploration game</Link></p>
                    <h2>Pangolin Run Minigame</h2>
                        <p>Help a pangolin race through the forest without hitting plants or birds in <Link to='/minigame1'>Pangolin Run Minigame</Link></p>
                    <h2>Nutrition Mission Minigame</h2>
                        <p>Help a pangolin get a meal without being hit by any rocks in <Link to='/minigame2'>Nutrition Mission Minigame</Link></p>
                    <h2>Credits</h2>
